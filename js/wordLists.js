// Word lists ported from the original Fake Hemingway app
// (https://github.com/SamWSoftware/Projects/tree/master/hemingway), reorganized
// as ES module exports.

// Words that end in "ly" but are NOT adverbs (e.g. "family", "belly"),
// used to avoid false-positive adverb flags.
export const NON_ADVERB_LY_WORDS = new Set([
  "actually",
  "additionally",
  "allegedly",
  "ally",
...
// Common irregular past participles that don't end in "-ed", so passive-voice
// detection ("was/were/is/are/been/being" + past participle) can catch
// sentences like "The cake was eaten" that the original app missed.
...
// Filler / hedging phrases that weaken a sentence.
export const QUALIFYING_PHRASES = new Set([
  "i believe",
  "i consider",
  "i don't believe",
  "i don't consider",
