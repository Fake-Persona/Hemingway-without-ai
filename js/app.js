...
window.hemingway = {
  ...
  // Stats only, without touching the DOM. The Android floating widget shows
  // counts over whatever you are typing in another app, so it needs the
  // numbers without rendering an editor it will never display. Returns a
  // JSON string because that is what survives the web view bridge intact.
  analyze(text) {
